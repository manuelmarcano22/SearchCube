...
##Emission Lines
class specto(object):
    def __init__(self,wave,flux,ra,dec,apperture,name):
        self.wave = wave
        self.flux = flux
        self.ra = ra
        self.dec = dec
...
def getspectrafromregion(spectralcube,ra,dec,aperture,name='name',xmin=6400.,xmax=6650.,exclude=[6520,6600,6660,6700]):
    ...
    pyspec.baseline(xmin=xmin, xmax=xmax,exclude=exclude,order=2,subtract=True)
    ...
    return specto(x,y,ra,dec,aperture,name)
